                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-12 text-center">
                            <h2 className="f_p f_size_40 l_height60 wow fadeInUp" data-wow-delay="0.3s">Обратная связь</h2>
                            ...
                            <form className="mailchimp wow fadeInUp" data-wow-delay="0.6s" method="post">
                                <div className="input-group subcribes">
                                    <input type="text" name="EMAIL" className="form-control memail" placeholder="techhub@gmail.com"/>
                                    <button className="btn btn_submit f_size_15 f_500" type="submit">ОК</button>
                                </div>
                            </form>
                        </div>
                    </div>
