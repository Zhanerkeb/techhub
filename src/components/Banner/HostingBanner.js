                ...
                <div className="row">
                    <div className="col-lg-6 col-md-7 d-flex align-items-center">
                        <div className="hosting_content">
                            <h2 className="wow fadeInUp" data-wow-delay="0.3s">Программа развития региональных партнеров</h2>
                            <p className="wow fadeInUp" data-wow-delay="0.5s">Программа развития региональных партнеровПрограмма развития региональных партнеровПрограмма развития региональных партнеров</p>
                            <a href="/#" className="hosting_btn btn_hover wow fadeInUp" data-wow-delay="0.7s">Подробнее</a>
                        </div>
                    </div>
