...
import RegionalDevelopment from "./Pages/Regional-development";
    ...
    return (
      <Router>
        <Switch>
          ...
          <ScrollToTopRoute path="/Zakupki" component={Service} />
          ...
          <ScrollToTopRoute path="/News" component={BlogGridPage} />
          ...
          <ScrollToTopRoute path="/Regional-development" component={RegionalDevelopment} />
          <ScrollToTopRoute
